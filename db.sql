...
--
-- Host: localhost:3306
-- Generation Time: Jan 19, 2025 at 09:52 AM
...
INSERT INTO `motor_status` (`id`, `motor_status`) VALUES
(1, 'OFF');
...
--
-- Indexes for table `motor_status`
--
ALTER TABLE `motor_status`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `motor_status`
--
ALTER TABLE `motor_status`
